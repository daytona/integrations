/*
 * Vercel deploy helper. Adapted from Stripe's MIT-licensed projects-templates
 * (https://github.com/stripe/projects-templates) — Copyright (c) Stripe.
 * Uploads the app and creates a production deployment via the Vercel API using
 * the credentials pulled by `stripe projects env --pull` (VERCEL_TOKEN, etc.).
 */
